    ...
    <div className="space-y-6">
      ...
      <div className="backdrop-blur-md bg-white/20 dark:bg-black/20 rounded-3xl p-6 shadow-xl border border-white/30 dark:border-white/10 hover:shadow-2xl transition-all duration-300">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-3xl font-bold text-gray-800 dark:text-gray-100">RESUME</h3>
      ...
      <div className="space-y-4">
        <h3 className="text-2xl font-bold text-gray-800 px-2 dark:text-gray-100 ">3+ YEARS OF EXPERIENCE as FREELANCER</h3>
